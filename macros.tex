...
\newcommand{\setSent}{\set{Sent}}

% Axiom names

\newcommand{\Imp}[1]{\textrm{imp$_{#1}$}}
\newcommand{\Uni}[1]{\textrm{uni$_{#1}$}}
\newcommand{\Rep}[1]{\textrm{rep$_{#1}$}}
\newcommand{\Del}[1]{\textrm{del$_{#1}$}}
\newcommand{\Nec}[1]{\textrm{nec$_{#1}$}}
\newcommand{\Conec}[1]{\textrm{conec$_{#1}$}}
